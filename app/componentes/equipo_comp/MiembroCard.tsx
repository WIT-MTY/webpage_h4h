...
const MiembroCard = (props: MiembroCardProps) => {
    return (
        <div className="bg-white w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl rounded-2xl flex flex-col md:flex-row items-center mx-auto" style={{background: "#815776"}}>
