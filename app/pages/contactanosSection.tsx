...
const ContactanosSection = () => {
    return (
      <Section id="contactanos" bg_color="#4A0C32" className="relative" overflow="overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center relative z-10 -mt-32 md:-mt-40 lg:-mt-48 px-4">
          <div className="-mb-8">
            <img className="w-40 sm:w-48 md:w-52 lg:w-44 xl:w-48 max-w-[min(15vw,12rem)] ease-in-out hover:scale-110 cursor-pointer" src="/images/h4h_logos/logo_h4h_corto.svg" alt="Logo H4H"></img>
          </div>
