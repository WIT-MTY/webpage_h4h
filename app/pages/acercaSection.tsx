...
const AcercaSection = () => {
    return (
        <Section id="acerca" backgroundColor="bg-secundario-rosa" className="h-full flex flex-col items-center justify-center">        <p className="text-secundario-morado text-2xl">Sección 1</p>
